...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-6">
      <div className="w-full max-w-sm space-y-5 border border-black/10 p-8 bg-white">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border border-black/20 py-2.5 text-sm hover:bg-black/5"
        >
          <GoogleIcon /> Continuer avec Google
        </button>

        <div className="my-2 flex items-center gap-3 text-xs text-black/50 uppercase tracking-wider">
